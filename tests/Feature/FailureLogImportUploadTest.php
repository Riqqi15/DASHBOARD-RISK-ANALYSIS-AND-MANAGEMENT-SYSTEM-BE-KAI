...
final class FailureLogImportUploadTest extends TestCase
{
    ...
    private function uploadedWorkbook(bool $includeUnmatchedReorderPath = false): UploadedFile
    {
        ...
        foreach ([
            'B3' => 'Subsystem', 'C3' => 'Jumlah Unit', 'D3' => 'Total Operating Hour',
            'E3' => 'Total Uptime', 'F3' => 'Total Downtime', 'G3' => 'Jumlah Failure',
            'H3' => 'MTTF', 'I3' => 'MTBF', 'J3' => 'Failure Rate', 'K3' => 'Reliability',
            'L3' => 'Availability', 'M3' => 'Jumlah penggantian sparepart',
        ...
        foreach ([
            'C9' => 'Lokasi', 'D9' => 'Resor', 'E9' => 'QC', 'F9' => 'Failure Event',
            'G9' => 'Penyebab', 'H9' => 'Tindakan', 'I9' => 'Penggantian Sparepart',
            'J9' => 'Tindak Vandalisme', 'K9' => 'Tanggal Kejadian',
            'L9' => 'Tanggal Penanganan', 'M9' => 'Mulai', 'N9' => 'Selesai',
        ] as $cell => $value) {
            $sheet->setCellValue($cell, $value);
        }
