...
class UpdateRegionalAccountRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'username' => ['required', 'string', 'min:3', 'max:50', 'regex:/\A[a-z0-9._-]+\z/', Rule::unique('users', 'username')->ignore($this->route('account'))],
            'email' => ['nullable', 'email', 'max:255', Rule::unique('users', 'email')->ignore($this->route('account'))],
            'unit_kerja_id' => [
                'required',
