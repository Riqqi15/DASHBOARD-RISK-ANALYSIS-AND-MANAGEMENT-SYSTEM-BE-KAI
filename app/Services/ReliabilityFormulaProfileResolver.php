...
final class ReliabilityFormulaProfileResolver
{
    ...
    {
        return [
            'downtime_mode' => $this->allowed(
                $profile['downtime_mode'] ?? null,
                ['minutes', 'hours', 'excel_day_fraction'],
                'minutes',
            ),
            'interval_baseline_date' => (string) ($profile['interval_baseline_date'] ?? $fallbackBaseline),
            'failure_count_mode' => $this->allowed(
                $profile['failure_count_mode'] ?? null,
                ['counta', 'counta_all_minus_1'],
                'counta',
            ),
            'spare_part_count_mode' => $this->allowed(
                $profile['spare_part_count_mode'] ?? null,
                ['counta', 'countif_ya'],
                'countif_ya',
            ),
            'vandalism_count_mode' => $this->allowed(
                $profile['vandalism_count_mode'] ?? null,
                ['counta', 'countif_ya'],
                'countif_ya',
            ),
