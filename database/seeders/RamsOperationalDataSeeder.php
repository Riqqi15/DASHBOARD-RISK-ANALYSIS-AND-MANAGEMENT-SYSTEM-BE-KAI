...
class RamsOperationalDataSeeder extends Seeder
{
    ...
    public function run(AssetCategoryResolver $categoryResolver, StockMovementService $stockMovementService): void
    {
        ...
        if (! $actor) {
            throw new RuntimeException(
                'RamsOperationalDataSeeder requires an active pusat user for auditable opening stock.',
            );
        }
        ...
        foreach (
            [
                [
                    ...
                    'PLC Failure, usia komponen > 5 tahun',
                    'Penggantian modul PLC',
                ...
                [
                    ...
                    'PSE-01',
                    'Sinyal Padam',
                    'Kabel putus akibat korosi',
                    'Perbaikan kabel instalasi',
                    RiskRegisterStatus::InProgress,
                ],
                [
                    'DAOP1',
                    'PENGGERAK WESEL ELEKTRIK',
                    'PWE-01',
                    'Wesel Tidak Mengunci',
                    'Clamp lock terganjal batu kerikil',
                    'Pembersihan area wesel rutin',
                ...
                [
                    ...
                    'Isolasi rel rusak, arus bocor',
                    'Ganti isolasi sambungan rel',
                    RiskRegisterStatus::Open,
                ],
                [
                    'DAOP1',
                ...
                [
                    ...
                    'SIM-01',
                    'Interlocking Mekanik Macet',
                    'Pelumasan kurang, komponen berkarat',
                    'Overhaul mekanisme interlocking',
                    RiskRegisterStatus::Open,
                ],
                [
                    'DIVRE4',
                    'KONTAK DETEKSI',
                    'KTD-01',
                    'Kontak Deteksi Tidak Respon',
                    'Kontak kotor/aus',
                    'Pembersihan dan penggantian pedal kontak',
                    RiskRegisterStatus::InProgress,
                ],
                [
                    'DIVRE4',
    ...
    private function seedReliabilitySummaries(): void
    {
        foreach (
            [
                ...
                ['DIVRE4', 'PERAGA SINYAL ELEKTRIK UTAMA', 744, 3, 1, 741, 3, 0.0013, 0.9987, 0.996],
    ...
    private function assetRows(): array
    {
        $definitions = [
            ...
            [
                '2. PERALATAN LUAR SINYAL ELEKTRIK',
                'PERAGA SINYAL ELEKTRIK',
                'PERAGA SINYAL ELEKTRIK PEMBANTU',
                12,
                '2015-06-01',
            ],
            [
                '2. PERALATAN LUAR SINYAL ELEKTRIK',
                'PERAGA SINYAL ELEKTRIK',
                'PERAGA SINYAL ELEKTRIK PELENGKAP',
                0,
                '2015-06-01',
            ],
            [
            ...
            [
                '4. PERALATAN LUAR SINYAL MEKANIK',
                'PERAGA SINYAL MEKANIK',
                'PERAGA SINYAL MEKANIK PEMBANTU',
                0,
                '1992-01-01',
            ],
            [
                '4. PERALATAN LUAR SINYAL MEKANIK',
                'PERAGA SINYAL MEKANIK',
                'PERAGA SINYAL MEKANIK PELENGKAP',
                0,
                '1992-01-01',
            ],
            ...
            [
                '4. PERALATAN LUAR SINYAL MEKANIK',
                'PENGONTROL DAN PETUNJUK KEDUDUKAN WESEL MEKANIK',
                'PENGONTROL DAN PETUNJUK KEDUDUKAN WESEL MEKANIK',
                0,
                '1995-01-01',
            ],
            [
                '4. PERALATAN LUAR SINYAL MEKANIK',
                'PENGAMAN WESEL SETEMPAT MEKANIK',
                'PENGAMAN WESEL SETEMPAT MEKANIK',
                0,
                '1995-01-01',
            ],
        ...
        foreach (
            [
                ...
                [
                    'unit' => 'DIVRE4',
                    'location' => 'Divre IV Tanjungkarang',
                    'quantities' => [1, 7, 23, 9, 10, 13, 12, 11, 19, 22, 23, 24, 25, 26, 27, 28, 84],
                ],
            ] as $area
        ) {
            foreach ($definitions as $index => [$group, $system, $subsystem, $quantity, $installedAt]) {
                $rows[] = [
                    ...
                    'installed_at' => $area['unit'] === 'DIVRE4' && $subsystem === 'CATU DAYA SINYAL'
                        ? '2010-01-01'
                        : $installedAt,
                ];
            }
    ...
    private function sparePartRows(): array
    {
        return [
            ...
            [
                'code' => 'SP-SU-001',
                'name' => 'Lampu LED Sinyal',
                'subsystem' => 'PERAGA SINYAL ELEKTRIK UTAMA',
                'stock' => 35,
            ],
            [
                'code' => 'SP-PM-001',
                'name' => 'Kawat Tarik Wesel',
                'subsystem' => 'PENGGERAK WESEL MEKANIK',
                'stock' => 50,
            ],
            [
                'code' => 'SP-SU-002',
            ...
            [
                'code' => 'SP-PE-001',
                'name' => 'Motor Point Wesel',
                'subsystem' => 'PENGGERAK WESEL ELEKTRIK',
                'stock' => 2,
            ],
            ...
            [
                'code' => 'SP-SP-001',
                'name' => 'Lampu LED',
                'subsystem' => 'PERAGA SINYAL ELEKTRIK PEMBANTU',
                'stock' => 40,
            ],
            ...
            [
                'code' => 'SP-PS-001',
                'name' => 'Gembok Wesel',
                'subsystem' => 'PENGAMAN WESEL SETEMPAT MEKANIK',
                'stock' => 15,
            ],
            [
                'code' => 'SP-PS-002',
    ...
    private function failureRows(): array
    {
        return [
            [
                ...
                'resort' => 'Resor 1.1 Manggarai',
                'event' => 'Modul CPU PLC Error',
                'cause' => 'Overheat pada ruang sintel',
                'action' => 'Reset PLC dan perbaikan ventilasi',
                'started_at' => '2026-07-05 08:15:00',
                'resolved_at' => '2026-07-05 14:15:00',
                'part_code' => null,
                'vandalism' => false,
            ],
            [
                ...
                'location' => 'Stasiun Manggarai',
                'resort' => 'Resor 1.1 Manggarai',
                'event' => 'Gangguan I/O Module',
                'cause' => 'Konektor longgar',
                'action' => 'Pemasangan ulang konektor',
                'started_at' => '2026-07-18 22:30:00',
                'resolved_at' => '2026-07-19 04:30:00',
                'part_code' => null,
                'vandalism' => false,
            ],
            [
                ...
                'resort' => 'Resor 1.2 Gambir',
                'event' => 'Track Circuit Intermittent',
                'cause' => 'Isolasi rel retak',
                'action' => 'Penggantian isolasi',
                'started_at' => '2026-07-12 03:00:00',
                'resolved_at' => '2026-07-12 11:00:00',
                'part_code' => 'SP-TC-003',
                'vandalism' => false,
            ],
            [
                ...
                'location' => 'Stasiun Jatinegara',
                'resort' => 'Resor 1.3 Jatinegara',
                'event' => 'Axle Counter Reset',
                'cause' => 'Petir menyambar jalur kabel',
                'action' => 'Reset sistem dan penggantian surge protector',
                'started_at' => '2026-07-22 15:00:00',
                'resolved_at' => '2026-07-22 19:00:00',
                'part_code' => 'SP-AC-004',
                'vandalism' => false,
            ],
            [
                ...
                'resort' => 'Resor 4.1 Tanjungkarang',
                'event' => 'Relay Kontak Kotor',
                'cause' => 'Debu dan kelembaban tinggi',
                'action' => 'Pembersihan dan pelumasan relay',
            ...
            [
                'unit' => 'DIVRE4',
                'subsystem' => 'INTERLOCKING MEKANIK',
                'location' => 'Stasiun Tanjungkarang',
                'resort' => 'Resor 4.1 Tanjungkarang',
                'event' => 'Handle Interlocking Macet',
                'cause' => 'Pelumasan kurang, karat',
                'action' => 'Overhaul dan pelumasan ulang',
                'started_at' => '2026-07-02 06:00:00',
                'resolved_at' => '2026-07-02 22:00:00',
                'part_code' => null,
                'vandalism' => false,
            ],
            [
                'unit' => 'DIVRE4',
                'subsystem' => 'INTERLOCKING MEKANIK',
                'location' => 'Stasiun Kedaton',
                'resort' => 'Resor 4.2 Kedaton',
                'event' => 'Handle Macet',
                'cause' => 'Komponen berkarat, usia > 30 tahun',
                'action' => 'Penggantian komponen mekanik',
                'started_at' => '2026-07-10 09:00:00',
                'resolved_at' => '2026-07-10 23:00:00',
                'part_code' => 'SP-IM-002',
                'vandalism' => false,
            ],
            [
                'unit' => 'DIVRE4',
                'subsystem' => 'INTERLOCKING MEKANIK',
                'location' => 'Stasiun Rejosari',
                'resort' => 'Resor 4.3 Rejosari',
                'event' => 'Kawat Interlocking Putus',
                'cause' => 'Tindak vandalisme - pencurian kawat',
                'action' => 'Pemasangan kawat baru dan pelaporan',
                'started_at' => '2026-07-20 04:00:00',
                'resolved_at' => '2026-07-20 22:00:00',
                'part_code' => 'SP-IM-001',
                'vandalism' => true,
            ],
        ];
