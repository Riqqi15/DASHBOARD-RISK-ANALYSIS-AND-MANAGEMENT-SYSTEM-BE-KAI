...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        DB::statement(
            'ALTER TABLE risk_matrices ADD CONSTRAINT chk_risk_matrices_likelihood CHECK (likelihood BETWEEN 1 AND 5)',
        );
        DB::statement(
            'ALTER TABLE risk_matrices ADD CONSTRAINT '
                .'chk_risk_matrices_consequence CHECK (consequence BETWEEN 1 AND 5)',
        );
        DB::statement(
            'ALTER TABLE risk_registers ADD CONSTRAINT '
                .'chk_risk_registers_likelihood CHECK (likelihood IS NULL OR likelihood BETWEEN 1 AND 5)',
        );
        DB::statement(
            'ALTER TABLE risk_registers ADD CONSTRAINT '
                .'chk_risk_registers_consequence CHECK (consequence IS NULL OR consequence BETWEEN 1 AND 5)',
        );
    }
};
